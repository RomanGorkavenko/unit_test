package ru.gb.seminars.sem1.calculator;
...
class CalculatorTest {
    ...
    @Test
    public void calculatingDiscount_amountTakingIntoAccountDiscount_successfully() {
        assertThat(Calculator.calculatingDiscount(100.1, 10))
                .isEqualTo(90.09, offset(0.0001));
    }

    @Test
    public void CalculatingDiscount_invalidInputData_ExceptionThrown() {
        assertThatThrownBy(() -> Calculator.calculatingDiscount(100.1, -1))
                .isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(100.1, 101))
                .isInstanceOf(ArithmeticException.class);
    }
